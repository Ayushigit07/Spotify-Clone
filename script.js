...
Array.from(document.getElementsByClassName("songsItemPlay")).forEach(
  (element) => {
    element.addEventListener("click", (e) => {
      ...
      audioElement.src = `songss/${songsIndex + 1}.mp3`;
      mastersongName.innerText = songss[songsIndex].songName;
